...
<section class="content-header">
    <h1>Pengguna <small>Tambah Pengguna Baru</small></h1>
    <ol class="breadcrumb">
    ...
    <section class="col-lg-6 col-lg-offset-3">       
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" required minlength="5" placeholder="Masukkan Password (min 5 karakter)">
            </div>
